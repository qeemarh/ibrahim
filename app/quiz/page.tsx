...
const quizQuestions = [
  {
    ...
    options: ['8th March', '28th March', '15th March', '20th March'],
    correctIndex: 0,
    hint: 'It was the day you messaged me "Asalamualaikum" during Ramadan...',
  },
  {
    id: 2,
    question: 'When is our anniversary?',
    options: ['8th March', '15th March', '28th March', '1st April'],
    correctIndex: 2,
    hint: 'The day you asked me to be your girlfriend with flowers and a handwritten letter...',
  },
  {
    id: 3,
    question: 'How long have we been together?',
    options: ['1 month', 'Almost 3 months', '6 months', '1 year'],
    correctIndex: 1,
    hint: 'Count from when we made it official...',
  },
  {
    id: 4,
    question: 'Which of these is NOT an inside joke between us?',
    options: ['Tunde', 'If you beat me, good for you. But if I beat you...', 'Sips self control sticker', 'None of the above'],
    correctIndex: 3,
    hint: 'All of these are things we laugh about together...',
  },
  {
    id: 5,
    question: 'Who first said "I love you"?',
    options: ['Asmau', 'Ibrahim'],
    correctIndex: 1,
    hint: 'Remember that first vulnerable moment...',
  },
  {
    id: 6,
    question: 'Who loves the other person most?',
    options: ['Asmau', 'Ibrahim'],
    correctIndex: 0,
    hint: 'Think about how much we love each other... but there\'s one answer that\'s true from my heart...',
  },
  {
    id: 7,
    question: 'What social media platform did we first communicate on?',
    options: ['WhatsApp', 'Instagram', 'Twitter', 'Facebook'],
    correctIndex: 1,
    hint: 'Where you sent me that first message...',
  },
  {
    id: 8,
    question: 'What was the first message you sent me?',
    options: ['Hello', 'Asalamualaikum', 'Hi beautiful', 'How are you?'],
    correctIndex: 1,
    hint: 'A greeting in Arabic during the holy month...',
  },
];
